...
export const projects = [
  ...
  },
  {
    ...
    description:
      "A classic Snake implementation built with C and SDL3, from scratch — no game engine.",
    stack: ["C", "SDL3"],
  ...
  },
  {
    index: "5",
    name: "MyScript",
    media: ["/projects/myscript_1.png", "/projects/myscript_2.png"],
    description:
      "A simple interpreter for a custom scripting language built from scratch in Go, supporting arithmetic and basic print operations.",
    stack: ["Go"],
  },

  {
    ...
    name: "Share Image",
    media: [
      "/projects/shareimage_1.png",
      "/projects/shareimage_2.png",
      "/projects/shareimage_3.png",
    ],
    description:
      "A Pasteboard-inspired image-sharing application with Go-based file handling and Redis-based expiration for automatic image cleanup.",
    stack: ["Go", "Fiber", "Next.js", "Redis", "Docker"],
    href: "https://github.com/PrashantGC00/share-image",
  },

  {
    ...
    name: "Duel Wordle",
    media: [
      "/projects/wordle_1.png",
      "/projects/wordle_2.png",
      "/projects/wordle_3.png",
      "/projects/wordle_4.png",
      "/projects/wordle_5.png",
      "/projects/worlde_7.png",
    ],
    description:
      "A real-time multiplayer Wordle-style game with a React frontend and Go backend, supporting multiplayer sessions through server-side game logic.",
    stack: ["Go", "Fiber", "WebSocket", "React", "Vite"],
  },
];
